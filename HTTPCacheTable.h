...
#endif
	CacheEntry *get_locked_entry_from_cache_table(int hash, const string &url);
...
public:
	...
	CacheEntry *read_entry(const string &url);
	CacheEntry *read_lock_entry(const string &url);
